namespace Radio
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            resources.ApplyResources(this.показатьСписокToolStripMenuItem, "показатьСписокToolStripMenuItem");
            ...
            resources.ApplyResources(this.таймерToolStripMenuItem, "таймерToolStripMenuItem");
